...
export default () => {
  ...
  return (
    <>
      ...
      <div class="container">
        <div class="cta text-secondary mx-4 my-5 text-center rounded-3">
          <div class="py-5">
            <h1 class="display-5 fw-bold text-primary">Interested in our services</h1>
            <div class="col-lg-6 mx-auto">
              <p class="fs-5 mb-4">
                Join uS now.</p>
              <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <button type="button" class="btn btn-primary btn-lg px-4 me-sm-3 fw-bold">Contact Us</button>
              </div>
            </div>
          </div>
          <div class="position-absolute"><svg viewBox="0 0 600 600" class="">
            ...
            <svg viewBox="0 0 600 600" class="GetStartedLight__DecoratorBlob2-sc-14djjkq-12 iNQuOi">
